            ...
            <div>
              ...
              <form
                onSubmit={(e) => {
                  ...
                  if (email) window.location.href = `mailto:hello@inovate.com?subject=Newsletter+Signup&body=Please+add+${encodeURIComponent(email)}+to+the+newsletter.`;
                }}
              ...
              >
                ...
                >
                  ...
                  <span className="text-sm font-semibold hidden sm:inline">Subscribe</span>
                </button>
              </form>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-gray-200 dark:border-zinc-800/60">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <a href="#" aria-label="Twitter" className="w-9 h-9 rounded-full bg-gray-200 dark:bg-zinc-900 border border-gray-300 dark:border-zinc-800 flex items-center justify-center text-gray-500 dark:text-zinc-500 hover:text-teal-500 hover:border-teal-500/30 transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
              </a>
              <a href="#" aria-label="LinkedIn" className="w-9 h-9 rounded-full bg-gray-200 dark:bg-zinc-900 border border-gray-300 dark:border-zinc-800 flex items-center justify-center text-gray-500 dark:text-zinc-500 hover:text-teal-500 hover:border-teal-500/30 transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
              </a>
              <a href="#" aria-label="GitHub" className="w-9 h-9 rounded-full bg-gray-200 dark:bg-zinc-900 border border-gray-300 dark:border-zinc-800 flex items-center justify-center text-gray-500 dark:text-zinc-500 hover:text-teal-500 hover:border-teal-500/30 transition-colors">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-2 text-xs text-gray-400 dark:text-zinc-600">
              <p>&copy; {new Date().getFullYear()} Inovate. All rights reserved.</p>
